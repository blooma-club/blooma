      ...
      <main className="flex-1 w-full max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground text-sm">
              Manage your scene and environment locations.
            </p>
          </div>
        ...
        {loading ? (
            ...
            {filteredLocations.map(location => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent">
                  <h3 className="text-white font-medium truncate text-xs">{location.name}</h3>
                  {location.subtitle && (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center border border-dashed border-border/30 rounded-2xl bg-muted/5 mt-8">
            ...
            <h3 className="text-sm font-medium text-foreground mb-1">No locations found</h3>
            <p className="text-xs text-muted-foreground max-w-[260px] mb-6 leading-relaxed">
              Upload a new location to start building your library.
            </p>
            <Button
              type="button"
              onClick={() => fileInputRef.current?.click()}
