...
const HeaderNavLink = memo(function HeaderNavLink({
  ...
  const isActive =
    pathname === link.href || (link.href !== '/studio/create' && pathname?.startsWith(link.href))
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          'absolute -bottom-0.5 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-foreground transition-all duration-300',
