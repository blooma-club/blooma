...
export default function AccountDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* 드롭다운 메뉴 */}
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-neutral-800 border border-neutral-700 rounded-lg shadow-lg z-50">
          {/* 사용자 정보 헤더 */}
          ...
          <div className="py-2">
            ...
            <button
              ...
              className="flex items-center gap-3 w-full px-4 py-2 text-sm text-red-400 hover:bg-neutral-700 hover:text-red-300 transition-colors"
            >
