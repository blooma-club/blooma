              ...
              >
                <div
                  className={`max-w-[78%] rounded-xl overflow-hidden shadow-sm transition ${
                    message.role === 'user' ? 'bg-white text-black px-4 py-3' : 'bg-white/10 text-white'
                  }`}
                >
                  {message.role === 'user' ? (
                    ...
                    <div className="space-y-0">
                      ...
                      {question && (
                        <div className="px-4 py-3">
                          ...
                          <p className="text-base font-medium text-white leading-relaxed mb-2">{question}</p>
                          {examples && (
                    ...
                    <div className="whitespace-pre-wrap text-sm leading-relaxed px-4 py-3">{message.content}</div>
                  )}
                </div>
              </div>
            )
